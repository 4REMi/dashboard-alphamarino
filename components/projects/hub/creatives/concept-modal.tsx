    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Emotional insight + Central tension */}
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <label className={labelCls}>Insight emocional</label>
              <textarea name="emotional_insight" defaultValue={concept?.emotional_insight ?? ""} rows={2} placeholder="Tensión interna del buyer persona" className={fieldCls} />
            </div>
            <div className="space-y-1">
              <label className={labelCls}>Tensión central</label>
              <textarea name="central_tension" defaultValue={concept?.central_tension ?? ""} rows={2} placeholder="El conflicto que el ad resuelve" className={fieldCls} />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea name="proposed_hook" defaultValue={concept?.proposed_hook ?? ""} rows={2} placeholder="Primera línea del anuncio" className={fieldCls} />
          </div>
          ...
          {isAdminOrSubadmin && (
            <div className="space-y-1 border-t pt-3">
              ...
              <textarea name="insight" defaultValue={concept?.insight ?? ""} rows={2} placeholder="Qué funcionó, qué no, aprendizajes del ciclo" className={fieldCls} />
            </div>
          )}
