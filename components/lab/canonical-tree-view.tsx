                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 flex items-center gap-1 text-xs text-primary hover:text-primary/80 transition-all px-2 py-1 rounded-md hover:bg-primary/10"
                    >
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 flex items-center gap-1 text-xs text-emerald-600 hover:text-emerald-700 transition-all px-2 py-1 rounded-md hover:bg-emerald-50 disabled:opacity-50"
                    >
...
function CanonicalTaskRow({
  ...
  return (
    <div className="group border-b border-border transition-colors hover:bg-muted/40">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          {canExpand && (
            <button
              ...
              className={cn(
                ...
                blockingCount > 0 ? "border-destructive/30 text-destructive bg-destructive/10 hover:bg-destructive/20" : "text-muted-foreground hover:bg-muted/80"
              )}
            >
              {blockingCount > 0 && <Lock className="w-2.5 h-2.5 mr-0.5" />}
              <ListChecks className="w-2.5 h-2.5 mr-0.5" />
              {task.checklist_items.length}
              <ChevronRight className={cn("w-2.5 h-2.5 ml-0.5 transition-transform", expanded && "rotate-90")} />
            </button>
          )}
          {task.requires_deliverable && <Paperclip className="w-3 h-3 text-info" />}
          {task.sop_title && (
            <span title={task.sop_title} className="inline-flex items-center rounded-full border border-primary/30 px-2 py-0.5 text-[10px] font-semibold bg-primary/10 text-primary">
          ...
          <div className="opacity-0 group-hover:opacity-100 flex items-center gap-1 transition-all">
            <button
              ...
              className="flex items-center gap-0.5 text-xs text-primary hover:text-primary/80 px-2 py-1 rounded-md hover:bg-primary/10 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-0.5 text-xs text-muted-foreground hover:text-foreground px-2 py-1 rounded-md hover:bg-muted transition-colors"
            >
      ...
      {expanded && (
        <div className="pl-9 pr-5 pb-3 space-y-1 border-t border-border/30 pt-2 bg-muted/10">
