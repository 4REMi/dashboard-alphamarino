...
export default async function ShareConceptsPage({ params }: Props) {
  ...
  // Order: concepts that have pending assets first, then by concept order
  ...
  return (
    ...
    >
      ...
      {/* ── Assets without any concepts (fallback) ──────────────── */}
...
// ─────────────────────────────────────────────────────────────────
// Concept group — strategy card + its assets
// ─────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────
// Asset review wrapper — adapts the row to the existing component
// ─────────────────────────────────────────────────────────────────
